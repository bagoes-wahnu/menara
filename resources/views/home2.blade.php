              ...
              <div class="card-body">
                <div id="modal-table1" class="table-responsive">
                  <table class="table">
                    <tr>
                      <th>Provider</th>
                      <td>{{ $aspects->provider }} </td>
                    </tr>
                    <tr>
                      <th>Tipe Tower</th>
                      <td>{{ $aspects->tipe_tower }}</td>
                    </tr>
                    <tr>
                      <th>Tinggi Tower</th>
                      <td>{{ $aspects->tinggi_tower }}</td>
                    </tr>
                    <tr>
                      <th>No UPT SKRK</th>
                      <td>{{ $aspects->no_upt_skrk }}</td>
                    </tr>
                    <tr>
                      <th>No UPT IMB</th>
                    ...
                    <tr>
                      <th>SK SKRK</th>
                      <td>{{ $aspects->sk_skrk }}</td>
                    </tr>
                    <tr>
                      <th>SK IMB</th>
                      <td>{{ $aspects->sk_imb }}</td>
                    </tr>
                    <tr>
                      <th>Nama Pemohon</th>
                    ...
                    <tr>
                      <th>Scan Zoning</th>
                      <td><a href="{{asset("storage/scan_skrk/$aspects->scan_zoning")}}" target="_blank">{{ $aspects->scan_zoning }}</a></td>
                    </tr>
                    <tr>
                      <th>Scan IMB</th>
                    ...
                    <tr>
                      ...
                      <td><a href="{{asset("storage/scan_imb/$aspects->scan_gambar_imb")}}" target="_blank">{{ $aspects->scan_gambar_imb }}</a></td>
                    </tr>
                  </table>
                </div>
              </div>
